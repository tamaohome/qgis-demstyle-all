...
1. [リリースノート](https://github.com/tamaohome/qgis-demstyle-all/releases) より最新リリースのZIPファイルをダウンロードします。
2. QGISウィンドウより「プラグイン」→「プラグインの管理とインストール...」を選択します。
3. 表示されたダイアログの右メニューより「ZIPからインストール」を選択します。
4. QGISを起動し、プラグイン管理画面で「DEMスタイル一括設定」を有効化します。
5. 「ZIPファイル」にダウンロードしたZIPファイルを指定し、「インストール」をクリックします。
6. プラグイン ツールバーまたはプラグインメニューから「DEMスタイル一括設定」を起動します。
